...
class SecureDB {
  ...
  /// ```
  static Future<void> setString(String key, String value, {String boxName = 'default'}) async {
    final box = await SecureHive.openBox<String>(boxName);
    await box.put(key, value);
  }

  static Future<String?> getString(String key, {String boxName = 'default'}) async {
    final box = await SecureHive.openBox<String>(boxName);
    return box.get(key);
  }

  static Future<void> setInt(String key, int value, {String boxName = 'default'}) async {
  ...
  static Future<void> setBool(String key, bool value, {String boxName = 'default'}) async {
  ...
  static Future<void> setMap(String key, Map<String, dynamic> value, {String boxName = 'default'}) async {
    final box = await SecureHive.openBox<Map<String, dynamic>>(boxName);
    await box.put(key, value);
  }

  static Future<Map<String, dynamic>?> getMap(String key, {String boxName = 'default'}) async {
    final box = await SecureHive.openBox<Map<String, dynamic>>(boxName);
    return box.get(key);
  }
